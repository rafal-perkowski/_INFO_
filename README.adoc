...
* {githubdir}/RankDatabase/{blobmasterdir}/README.adoc[Projekt nr 2]: Implementacja relacyjnej bazy danych (MySQL)
* {githubdir}/RankApplication/{blobmasterdir}/README.adoc[Projekt nr 3]: Aplikacja w języku Python łącząca z bazą danych (Python, PyMySQL)
* {githubdir}/KursyPWN/{blobmasterdir}/README.adoc[Projekt nr 4]: Program do oceny projektów kursantów (JavaSE, JDBC, JavaFX, MySQL)
