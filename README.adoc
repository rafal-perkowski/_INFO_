...
* {githubdir}{project02dir}{blobmasterdir}/README.adoc[Projekt nr 2]: Implementacja relacyjnej bazy danych (MySQL)
* {githubdir}{project03dir}{blobmasterdir}/README.adoc[Projekt nr 3]: Aplikacja w języku Python łącząca z bazą danych (Python, PyMySQL)
* {githubdir}{project04dir}{blobmasterdir}/README.adoc[Projekt nr 4]: Program do oceny projektów kursantów (JavaSE, JDBC, JavaFX, MySQL)
